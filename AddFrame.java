...
lblName = new JLabel("Enter name : ");			lblName.setFont(f);
txtName = new JTextField(18);				txtName.setFont(f);
lblMrk1 = new JLabel("Enter marks of sub1 : ");		lblMrk1.setFont(f);
txtMrk1 = new JTextField(18);				txtMrk1.setFont(f);
lblMrk2 = new JLabel("Enter marks of sub2 : ");		lblMrk2.setFont(f);
txtMrk2 = new JTextField(18);				txtMrk2.setFont(f);
lblMrk3 = new JLabel("Enter marks of sub3 : ");		lblMrk3.setFont(f);
...
try{
	...
	DbHandler.addStudent(Integer.parseInt(txtRno.getText()), txtName.getText(), Integer.parseInt(txtMrk1.getText()), Integer.parseInt(txtMrk2.getText()), Integer.parseInt(txtMrk3.getText()));
...
/*catch(NumberFormatException e) {
	...
	JOptionPane.showMessageDialog(c, "Roll no already exists.", "Error", JOptionPane.ERROR_MESSAGE);
}
catch(Exception e){
